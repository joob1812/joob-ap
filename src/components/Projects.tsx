      ...
      <div className="col-span-2 mt-[60px] ">
        <div className='dark:bg-gray-900'>
          <div className='hscreen flex justify-center flex-col items-center'>
            ...
            <h2 className='mt-4 md:text-[50px] text-[30px] text-center text-yellow-600 dark:text-yellow-500 font-bold tracking-widest'>PAPE MOUSSA <br></br>DIOP</h2>
            <img src="/Avatar_2.jpg" alt="Avatar Pic"
              className='w-[150px] h-[150p] bg-yellow-300 p-3 rounded-full shadow-lg mt-6' />
            <h2 className='mt-4 text-center text-gray-800 font-medium text-[13px]
                 dark:text-gray-200'
